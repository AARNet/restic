...
func restoreAndVerify(t *testing.T, tempdir string, content []TestFile, files map[string]bool, dryrun bool) {
	...
	verifyRestore(t, r, repo, dryrun)
}

func verifyRestore(t *testing.T, r *fileRestorer, repo *TestRepo, dryrun bool) {
